...
Types](https://proactiveprogrammers.com/discrete-structures/source-code-surveys/data-types/)
...
- Run both of the provided Python scripts by typing the following:
  - `python demonstrate-variable-limitations.py`: demonstrate the limitations of
    the int data types when used in exponentiation
  - `python compare-variables.py`: compare different floating point values
